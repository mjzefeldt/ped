      ...
      for (
        ...
        !(function(a) {
          for (
            ...
            (e = e.n),
              (e = (e.hasOwnProperty(d[g]) && e[d[g]]) || (e[d[g]] = {n: {}}))
        ...
        for (d = 0, i = c.length; i > d; d++)
          for (p = 0; p < r.length; p += m.length - 2) {
            if (((m = [p, 1]), (k = r[p].n), c[d] != h))
              ...
              for (l in k) k[e](l) && (m.push(k[l]), s.unshift({n: k, name: l}))
            r.splice.apply(r, m)
          }
            ...
            function d(a) {
              return function(c) {
                ...
                if ('marker' == c.type) {
                  var e = c.node.id
                  return (
                    e || p(c.node, {id: c.id}), void (this.node.style[d] = q(e))
                  )
                }
              }
            }
      ...
      d.plugin(function(c, d, e, f, g) {
        ...
        ;(h.image = function(a, b, d, e, f) {
          ...
          (h.use = function(a) {
            return null != a
              ? (a instanceof d &&
                  (a.attr('id') || a.attr({id: c._.id(a)}), (a = a.attr('id'))),
          ...
          return a._.cacher(
            function(a, f, g) {
              ...
              return (
                ...
                (n = c
                  ? q
                  : d ? p : k(h, j, l[0], l[1], l[2], l[3], l[4], l[5], 1))
              )
            },
            null,
            a._.clone
          ...
          for (
            var d = B(a),
              ...
              j = function(a, b, c) {
                ...
                switch ((!(a[0] in {T: 1, Q: 1}) && (b.qx = b.qy = null),
                a[0])) {
                  case 'M':
                    ;(b.X = a[1]), (b.Y = a[2])
                    break
